...
const COUNTRY_TO_CODE: Record<string, string> = {
    ...
    'Hungary': 'hu', 'Armenia': 'am', 'Moldova': 'md',
    'Unknown': '',
};
...
/**
 * Full list of unique ISO alpha-2 country codes for flag preloading.
 */
export const COUNTRY_CODES_LIST: string[] = [
    ...new Set(Object.values(COUNTRY_TO_CODE).filter(Boolean))
];
